...
func generateServerSetup(buf *bytes.Buffer, serviceName string, service *specification.Service, currentResource specification.Resource, currentEndpoint specification.Endpoint, apiPackageName string) error {
	...
	buf.WriteString("\t\t\t\t},\n")
	buf.WriteString(fmt.Sprintf("\t\t\t\tErrorHook: func(err error, requestID string) *%s.Error {\n", apiPackageName))
...
func generateServeWithResponseTest(buf *bytes.Buffer, apiPackageName string) error {
	...
	buf.WriteString("\t\t},\n")
	buf.WriteString("\t\tErrorHook: func(err error, requestID string) *" + apiPackageName + ".Error {\n")
...
func generateHandleRequestTest(buf *bytes.Buffer, apiPackageName string) error {
	...
	buf.WriteString("\t\t_, apiError := " + apiPackageName + ".HandleRequest[any, struct{}, struct{}, TestBodyParams](c, requestContext, server)\n")
...
func generateInternalUtilityTests(buf *bytes.Buffer, service *specification.Service) error {
	...
	buf.WriteString("\t\t_, apiError := HandleRequest[any, struct{}, struct{}, TestBodyParams](c, requestContext, server)\n")
	buf.WriteString("\t\tassert.NotNil(t, apiError, \"Expected API error when JSON is invalid\")\n")
