...
func generateServer(buf *bytes.Buffer, service *specification.Service) error {
	...
	buf.WriteString("\t// GetRequestIDFunc is a function that generates a unique request ID for each request\n")
	buf.WriteString("\t// If not provided, a UUID will be generated by default\n")
